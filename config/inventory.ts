...
export const inventory: InventoryProduct[] = [
  ...
  },
  {
    ...
    sku: "virat_kohli",
    name: "Virat Kohli",
    description: `Virat Kohli is an Indian international cricketer and the former captain of the Indian national cricket team. Widely regarded as one of the greatest batsmen in the history of the sport, he plays for Royal Challengers Bangalore in the IPL and Delhi in domestic cricket.`,
    price: 10000,
    image:
      "",
    images: [
